...
<script type="text/javascript" src="resources/dist/js/teacher.js"></script>
	...
	<nav class="navbar navbar-default" role="navigation">
	  <div class="container-fluid">
	    ...
	    <div class="navbar-header">
	      ...
	      <a class="showLoginlog navbar-brand" href="#">教师</a>
	    </div>
	
	    <!-- Collect the nav links, forms, and other content for toggling -->
	    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
	      <ul class="nav navbar-nav">
	        <li><a href="#">学生学籍信息管理</a></li>
	        <li><a href="#">课程信息管理</a></li>	 
	        <li><a href="#">成绩信息管理</a></li>
	      </ul>
	      <form class="navbar-form navbar-left" role="search">
	        <div class="form-group">
	          <input type="text" class="form-control" placeholder="请输入学生学号或姓名">
	        </div>
